=begin
== Popis
Tento model slúži na ukladanie obsahu podstránky webu. Model obsahuje relácie na dalšie modeli a
...
name. Platia pre neho rovnaké validačné pravidlá ako pre name parameter.
...
Pred uložením podstránky sa robí úprava parametra name a uloženie do url_name na účelom správneho generovania odkazu.
...
class Page < ActiveRecord::Base
  ...
  private
    ...
    #Obstránenie nepoužívaných obrázkov.
